...
Object.assign(T, {
  ko: makeLang({
    ...
    early_member:'얼리 멤버', early_member_boost:'얼리 멤버 — 매장 추천 상위 노출',
    boost_modal_title:'매장 추천에 노출되기', boost_modal_body:'일찍 가입해 주셔서 감사합니다! 프로필을 자세히 작성하면 매장 추천 후보에서 더욱 우선적으로 표시됩니다.', boost_modal_progress:'프로필 완성도', boost_modal_cta:'프로필 설정하기', boost_modal_later:'나중에',
  ...
  zh: makeLang({
    ...
    early_member:'早期会员', early_member_boost:'早期会员 — 优先展示给商家',
    boost_modal_title:'获得商家推荐展示', boost_modal_body:'感谢您的早期注册！完善个人资料后，您将在商家的推荐候选人中获得更优先的展示。', boost_modal_progress:'资料完成度', boost_modal_cta:'完善我的资料', boost_modal_later:'稍后',
  ...
  es: makeLang({
    ...
    early_member:'Miembro inicial', early_member_boost:'Miembro inicial — más visible para empleadores',
    boost_modal_title:'Destaca ante los empleadores', boost_modal_body:'¡Gracias por registrarte temprano! Completa tu perfil en detalle para aparecer aún más arriba entre los candidatos recomendados a los empleadores.', boost_modal_progress:'Perfil completado', boost_modal_cta:'Completar mi perfil', boost_modal_later:'Más tarde',
  ...
  fr: makeLang({
    ...
    early_member:'Membre des débuts', early_member_boost:'Membre des débuts — mieux visible auprès des employeurs',
    boost_modal_title:'Démarquez-vous auprès des employeurs', boost_modal_body:'Merci de votre inscription anticipée ! Complétez votre profil en détail pour apparaître encore plus haut parmi les candidats recommandés aux employeurs.', boost_modal_progress:'Profil complété', boost_modal_cta:'Compléter mon profil', boost_modal_later:'Plus tard',
  ...
  pt: makeLang({
    ...
    early_member:'Membro inicial', early_member_boost:'Membro inicial — mais visível para empregadores',
    boost_modal_title:'Destaque-se para os empregadores', boost_modal_body:'Obrigado por se cadastrar cedo! Complete seu perfil em detalhes para aparecer ainda mais acima entre os candidatos recomendados aos empregadores.', boost_modal_progress:'Perfil completo', boost_modal_cta:'Completar meu perfil', boost_modal_later:'Mais tarde',
  ...
  vi: makeLang({
    ...
    early_member:'Thành viên sớm', early_member_boost:'Thành viên sớm — ưu tiên hiển thị với nhà tuyển dụng',
    boost_modal_title:'Nổi bật với nhà tuyển dụng', boost_modal_body:'Cảm ơn bạn đã đăng ký sớm! Hoàn thiện hồ sơ chi tiết để được hiển thị ưu tiên hơn nữa trong danh sách ứng viên gợi ý cho nhà tuyển dụng.', boost_modal_progress:'Mức độ hoàn thiện hồ sơ', boost_modal_cta:'Hoàn thiện hồ sơ', boost_modal_later:'Để sau',
  ...
  id: makeLang({
    ...
    early_member:'Member Awal', early_member_boost:'Member Awal — tampil lebih utama ke pemberi kerja',
    boost_modal_title:'Tampil menonjol ke pemberi kerja', boost_modal_body:'Terima kasih sudah mendaftar lebih awal! Lengkapi profilmu secara detail agar tampil lebih utama di kandidat rekomendasi pemberi kerja.', boost_modal_progress:'Kelengkapan profil', boost_modal_cta:'Lengkapi profil saya', boost_modal_later:'Nanti saja',
